...
const Header = () => {
  ...
  return (
    <div className="flex w-[100%] items-center justify-between mob:justify-normal shadow-lg h-14 left-0 top-0">
      <Link to="/">
      ...
      <div>
        <ul className="flex text-xl sm:text-sm xsm:text-xs mob:text-xs">
          <Link to='/'>
